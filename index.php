...
<div class="container-fluid border-bottom-8">
	<div class="row">
		...
		<div class="col-md-4 text-center nav-height bg-ui">
			...
			<p>Enhancing Customer Engagement<br /><a href="case-studies/imh-homepage.php" class="button-nav">Read Case Study &gt;&gt;</a></p>
		</div>
		<div class="col-md-4 text-center nav-height bg-ux">
			<p class="heading">Search Engine Optimization</p>
			<p>Experienced in increasing website rankings<br /><a class="button-nav coming-soon">&nbsp;</a></p>
		</div>
	</div>
</div>
