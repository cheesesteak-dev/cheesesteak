...
<div class="container-fluid section-break">
	<div class="row">
		...
		<div class="row zero-padmarg">
			...
			<div class="col-md-4 text-center">
				<h4>No Product Recognition</h4>
			</div>
			<div class="col-md-4 text-center">
				<h4>Incoherent Messaging</h4>
			</div>
		</div>
	</div>
</div>
...
<div class="container-fluid section-break case-border">
	...
	<div class="row zero-padmarg">
		...
		<div class="col-md-4">
			<h4 class="break">Extensive Research</h4>
	...
	<div class="row zero-padmarg pad-alternate">
		...
		<div class="col-md-4">
			<h4 class="break">New Copy</h4>
			<p>All the copy on the page was written by me. My goal was to keep copy to a minimum.</p>
		</div>
	</div>
</div>
...
<div class="container-fluid section-break case-border">
	...
	<div class="row zero-padmarg">
		...
		<div class="col-md-5">
			<img src="http://placehold.it/668x800" class="img-responsive" />
			<p class="text-justify">The final design was a rethink of our approach. We decided to go with a 2 column approach to fit in the more attention grabbing material. In the original concept, this section was placed far down in the page.</p>
			<p>BUTTONS</p>
		</div>
	</div>
	<div class="row zero-padmarg">
...
<div class="container-fluid section-break case-border">
	...
	<div class="row zero-padmarg breakdown-break">
		...
		<div class="col-md-4">
			<h4 class="break">Value Proposition</h4>
	...
	<div class="row zero-padmarg breakdown-break">
		...
		<div class="col-md-4">
			<h4 class="break">Benefits &amp; Trust Building</h4>
	...
	<div class="row zero-padmarg breakdown-break">
		...
		<div class="col-md-4">
			<h4 class="break">Promoting Our Knowledge</h4>
	...
	<div class="row zero-padmarg breakdown-break">
		...
		<div class="col-md-4">
			<h4 class="break">More Trust Builders</h4>
	...
	<div class="row zero-padmarg breakdown-break">
		...
		<div class="col-md-4">
			<h4 class="break">Call to Actions</h4>
...
<div class="container-fluid">
	<div class="row three-up">
		...
		<div class="col-md-4 text-center">
			<h4>Created a Content Rich Landing Page</h4>
		</div>
		<div class="col-md-4 text-center">
			<h4>Increased Product Knowledge</h4>
		</div>
		<div class="col-md-4 text-center">
			<h4>Validated Our Support Team</h4>
		</div>
	</div>
</div>
